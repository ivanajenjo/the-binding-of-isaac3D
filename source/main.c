...
static void shootUp(){
	C2D_SpriteSetRotation(&mainCharacter.spr, C3D_Angle(20));
}

static void shootDown(){
	C2D_SpriteSetRotation(&mainCharacter.spr, C3D_Angle(10));
}
...
static void shootLeft(){
	C2D_SpriteSetRotation(&mainCharacter.spr, C3D_Angle(30));
}
